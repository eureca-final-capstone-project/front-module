...
const RefundBankSelector = () => {
  ...
  return (
    <div
      className={`${isMobile ? 'scrollbar-hide flex gap-2 overflow-x-auto px-1 whitespace-nowrap sm:px-0' : 'flex flex-wrap gap-2'}`}
    >
      {banks.map(bank => {
        ...
        return (
          <Button
            ...
            mediumPadding
            className={`text-fs16 rounded-2 my-1 sm:my-0 ${
